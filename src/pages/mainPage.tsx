...
const MainPage: React.FC = () => {
  ...
  const getStatus = () => {
    if (reviewsStatus === "loading" || toursStatus === "loading" || teamStatus === "loading") return "loading"
    if (reviewsStatus === "failed" || toursStatus === "failed" || teamStatus === "failed") return "succeeded"
